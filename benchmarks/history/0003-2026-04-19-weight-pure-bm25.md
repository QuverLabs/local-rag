# Benchmark 0003 — weight-pure-bm25

- **Run date:** 2026-04-19 15:39:15
...
|---|---|---|---|---|---|
| A | 6 | 83% | 100% | 0.889 | 1.0673 |
| B | 4 | 75% | 100% | 0.875 | 0.8827 |
| C | 4 | 75% | 75% | 0.750 | 1.1127 |
| D | 3 | 0% | 0% | 0.000 | 0.8180 |
| E | 1 | 100% | 100% | 1.000 | 1.2463 |

**Discrimination gap (A vs. D, avg top-1):** `+0.2494`  
...
- **Latency:** 41.9 ms
- **Top-K:**
  - [✓] `1.9112` — `uslugi/renowacja-dachu.md`
  - [ ] `1.6575` — `index.md`
  - [✓] `1.4085` — `uslugi/renowacja-dachu.md`
  - [ ] `0.8908` — `o-nas.md`
...
- **Top-K:**
  - [✓] `1.2463` — `index.md`
  - [ ] `1.2027` — `o-nas.md`
  - [✓] `1.0451` — `uslugi/systemy-asekuracyjne.md`

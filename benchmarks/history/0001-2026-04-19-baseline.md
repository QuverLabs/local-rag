# Benchmark 0001 — baseline

- **Run date:** 2026-04-19 15:39:04
...
|---|---|---|---|---|---|
| A | 6 | 83% | 100% | 0.889 | 0.9081 |
| B | 4 | 75% | 100% | 0.875 | 0.8827 |
| C | 4 | 75% | 75% | 0.750 | 0.8777 |
| D | 3 | 0% | 0% | 0.000 | 0.8180 |
| E | 1 | 100% | 100% | 1.000 | 1.0000 |

**Discrimination gap (A vs. D, avg top-1):** `+0.0901`  
...
- **Latency:** 78.9 ms
- **Top-K:**
  - [✓] `0.9556` — `uslugi/renowacja-dachu.md`
  - [ ] `0.8908` — `o-nas.md`
  ...
  - [ ] `0.8867` — `uslugi.md`
  - [ ] `0.8287` — `index.md`
  - [✓] `0.7042` — `uslugi/renowacja-dachu.md`
...
- **Top-K:**
  ...
  - [ ] `0.8274` — `polityka-prywatnosci.md`

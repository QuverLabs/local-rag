# Benchmark 0007 — text-normalization

- **Run date:** 2026-04-20 04:02:16
...
|---|---|---|---|---|---|
| A | 6 | 83% | 100% | 0.917 | 0.9160 |
| B | 4 | 75% | 100% | 0.875 | 0.8871 |
| C | 4 | 75% | 75% | 0.750 | 0.8614 |
| D | 3 | 0% | 0% | 0.000 | 0.8146 |
| E | 1 | 0% | 100% | 0.500 | 0.8630 |

**Discrimination gap (A vs. D, avg top-1):** `+0.1014`  
...
- **Top-K:**
  ...
  - [✓] `0.8742` — `index.md`
  - [✓] `0.8721` — `index.md`
  - [ ] `0.8713` — `uslugi/serwis-membran-pvc.md`
  - [✓] `0.8705` — `uslugi.md`
  - [ ] `0.8702` — `o-nas.md`
  - [✓] `0.8694` — `index.md`
...
- **Top-K:**
  - [✓] `0.8507` — `kontakt.md`
  - [ ] `0.8350` — `polityka-prywatnosci.md`
  - [ ] `0.8332` — `polityka-prywatnosci.md`
  - [ ] `0.8323` — `polityka-prywatnosci.md`
  - [ ] `0.8296` — `polityka-prywatnosci.md`
  - [ ] `0.8276` — `klauzula-informacyjna.md`
  - [ ] `0.8276` — `klauzula-informacyjna.md`
  - [✓] `0.8267` — `kontakt.md`
  - [ ] `0.8267` — `klauzula-informacyjna.md`
  - [ ] `0.8259` — `klauzula-informacyjna.md`
...
- **Latency:** 23.0 ms
- **Top-K:**
  - [ ] `0.8437` — `realizacje.md`
  - [ ] `0.8403` — `o-nas.md`
  - [ ] `0.8397` — `uslugi.md`
  - [ ] `0.8385` — `uslugi.md`
  - [ ] `0.8375` — `realizacje.md`
  - [ ] `0.8373` — `o-nas.md`
  - [ ] `0.8348` — `uslugi.md`
  - [ ] `0.8348` — `o-nas.md`
  - [ ] `0.8330` — `404.md`
  - [ ] `0.8310` — `realizacje.md`
...
- **Top-K:**
  ...
  - [ ] `0.8390` — `uslugi/termomodernizacja-dachu.md`
